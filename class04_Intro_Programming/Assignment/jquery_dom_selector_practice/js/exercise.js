 ...
 * When button 1 is clicked, select the ordered list item that has the class "falseFact". 
 ...
 // */
	...
	//  function question3(){
	//  	$(".falseFact").html("<span>True Fact</span>"); }
...
// function question8(){
// 	$(".city").attr("src", "http://lorempixel.com/g/500/400/food");
// 	console.log("We changed the picture of the city to the burger");
// 	alert("We changed the picture of the city to the burger");
// }
// We changed the picture of the city to the burger
